...
namespace Client.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Secret()
        {
            ...
            var serverResponse = await _client.GetAsync("https://localhost:44303/secret/index");
            var apiResponse =  await _client.GetAsync("https://localhost:44359/secret/index");
            return View();
        }
    }
}
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Secret()
        {
            ...
            var apiResponse = await AccessTokenRefreshWrapper(
                () => SecuredGetRequest("https://localhost:44359/secret/index"));
